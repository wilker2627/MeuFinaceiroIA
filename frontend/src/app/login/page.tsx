...
import { Eye, EyeOff, Mail, Lock, Loader, UserRound, Building2, ShieldCheck, ChevronRight, ArrowLeft } from 'lucide-react'
...
export default function LoginPage() {
  ...
  const [accessMode, setAccessMode] = useState<'selector' | 'personal'>('selector')
        ...
        {accessMode === 'selector' ? (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <h1 className="text-4xl font-black text-white tracking-tight">Bem-vindo ao FinanceiroAI</h1>
              <p className="text-slate-300 mt-2 text-base">Como você deseja acessar?</p>
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full rounded-2xl border border-emerald-500/40 bg-gradient-to-br from-emerald-500/12 to-slate-900/85 p-4 text-left transition hover:border-emerald-400/70"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-xl font-bold text-emerald-300">Pessoa Física</p>
                    <p className="text-sm text-slate-300">Acesse e gerencie suas finanças pessoais.</p>
                  </div>
              ...
              <Link
                ...
                className="block w-full rounded-2xl border border-cyan-500/40 bg-gradient-to-br from-cyan-500/12 to-slate-900/85 p-4 transition hover:border-cyan-400/70"
              >
                <div className="flex items-center gap-3">
                  <div className="rounded-full bg-cyan-500/20 p-3">
                    <Building2 size={26} className="text-cyan-300" />
                  </div>
                  <div className="flex-1">
                    <p className="text-xl font-bold text-cyan-300">Empresa</p>
                    <p className="text-sm text-slate-300">Acesse e gerencie as finanças da sua empresa.</p>
                  </div>
            ...
            <div className="pt-2 border-t border-slate-800">
              <Link
                href="/admin/login"
                className="flex items-center justify-center gap-2 w-full rounded-xl border border-slate-600 bg-slate-900/70 px-4 py-3 text-slate-200 font-semibold hover:bg-slate-800 transition"
              >
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="bg-gradient-to-br from-slate-900/80 to-slate-950 border border-cyan-500/20 rounded-2xl p-8 backdrop-blur-xl shadow-2xl space-y-4">
              <div className="mb-2">
                <button
                  type="button"
                  onClick={() => setAccessMode('selector')}
