    ...
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-600 pointer-events-none">
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        ...
        <div className="relative w-40 h-40 flex items-center justify-center">
          ...
          <div className="relative w-28 h-28 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-2xl">
            <span className="text-5xl font-black text-slate-900 select-none">MF</span>
          </div>
        </div>

        {/* App Name */}
        <div className="text-center">
          <h1 className="text-4xl font-bold text-cyan-100 tracking-wide">MeuFinanceiro</h1>
          <p className="text-cyan-300 text-sm font-semibold mt-2 tracking-widest">AI ASSISTANT</p>
        </div>
